    ...
    html.Div(className='main-content-wrapper', children=[
        ...
        html.Div(id='main-content', children=[
            ...
            html.Div(className='contact-section', children=[
                ...
                html.P(
                    "Olá! Meu nome é Felipe e sou um profissional com experiência em marketing e análise de dados, "
                    "buscando oportunidades em programação, análise de dados e inteligência artificial. "
                    "Este projeto é um exemplo do meu trabalho e paixão por combinar análise com soluções práticas.",
                ...
                html.Div(className='contact-links', children=[
                    html.A(
                        ...
                        href="[COLOQUE SEU LINK DO LINKEDIN AQUI]", # NÃO ESQUEÇA DE PREENCHER!
                        ,
                    ...
                    html.A(
                        ...
                        href="[COLOQUE SEU LINK DO GITHUB AQUI]", # NÃO ESQUEÇA DE PREENCHER!
                        ,
                        className='contact-link'
                    )
                ])
...
@app.callback(
    ...
    [Input('num-empresas-slider', 'value'),
     Input('min-volume-input', 'value'), # Input é string formatada
...
@app.callback(
    ...
    [Input('magic-formula-table', 'selected_rows'),
     Input('total-investimento-input', 'value'), # Input é string formatada
