...
.contact-section {
    padding: 30px 20px;
    background-color: var(--table-bg-color-odd); /* Fundo sutil para a seção */
    border-radius: 8px;
    margin-top: 40px; /* Espaçamento da seção anterior */
...
.contact-link {
    background-color: var(--primary-color);
    color: var(--text-color-light) !important; /* Texto branco */
    padding: 12px 25px;
    border-radius: 5px;
...
.contact-link:hover {
    background-color: var(--secondary-color); /* Dourado no hover */
    color: var(--primary-color) !important; /* Texto azul no hover */
}
